...
public class AboutVision extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String mision = "<h2>Nuestra Misión</h2> Ser un aporte positivo a nuestra sociedad, brindando un servicio de diagnostico laboratorial de alta calidad y utilidad medica y gran beneficio a nuestros pacientes. <br><br> Para este cometido contamos con cuatro pilares fundamentales como son la resposabilidad, la eficacia, la calidad y la calidez.";
		String vision = "<h2>Nuestra Visión</h2>  Llegar a consagrarnos en una institución respetable y confiable de apoyo diagnostico laboratorial, satisfechos de haber contribuido al desarrollo en salud hospitalaria de nuestra sociedad. <br><br> Ser reconocido sobre todo por nuestra actitud profesional y humana.";
		String values = "<h3>Nuestras actividades se basan en los siguientes valores</h3>Honestidad<br>Confiabilidad<br>Respeto<br>Experiencia<br>Espiritu de servicio<br>Trabajo en equipo<br>Responsabilidad<br>"; 
